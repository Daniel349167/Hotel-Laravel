    ...
    $('body').on('click', '.btn-detail', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                $('#form_edit input[name="detalle"]').val(r.room.detalle);
                $(`#form_edit select[name="idsala"] option[value="${r.room.idsala}"]`).prop('selected', true);
                $(`#form_edit select[name="idcategoria"] option[value="${r.room.idcategoria}"]`).prop('selected', true);
