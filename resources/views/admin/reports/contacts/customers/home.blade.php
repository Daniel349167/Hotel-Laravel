            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form-contacts-customers" method="POST" class="form form-vertical"
                            action="{{ route('admin.export_contacts_customers') }}" target="_blank">
                            @csrf
                            <div class="row">
                                <div class="mt-3">
...
@endsection
@section('scripts')
    @include('admin.reports.contacts.customers.js-home')
@endsection
