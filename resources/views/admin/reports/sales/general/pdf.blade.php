    ...
    <div id="items">
        <table id="table_items">
            ...
            <tbody>
                ...
                @endforeach
                <tr>
                    <td colspan="10" class="text-right border-solid">Total Q &nbsp;</td>
                    <td class="td_items border-solid">{{ number_format($total, 2, '.', '') }}</td>
                </tr>
                <tr>
                    <td colspan="10" class="text-right border-solid text-danger">Anulado Q &nbsp;</td>
                    <td class="td_items border-solid text-danger">{{ number_format($anulado, 2, '.', '') }}</td>
                </tr>
                <tr>
                    <td colspan="10" class="text-right border-solid">Total Neto Q &nbsp;</td>
