            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="form-sales-general" method="POST" class="form form-vertical"
                            action="{{ route('admin.export_sales_general') }}" target="_blank">
                            @csrf
                            <div class="row">
                                    ...
                                    <table class="table table-sm mb-0 fs--1">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center">Doc. Relacionado</th>
...
@endsection
@section('scripts')
    @include('admin.reports.sales.general.js-home')
@endsection
