    ...
    $('body').on('click', '.btn-detail', function()
    {
        ...
        $.ajax({
            ...
            success     : function(r){
                ...
                close_block('#layout-content');
                $('#form_edit input[name="id"]').val(r.hall.id);
                $('#form_edit input[name="descripcion"]').val(r.hall.descripcion);
